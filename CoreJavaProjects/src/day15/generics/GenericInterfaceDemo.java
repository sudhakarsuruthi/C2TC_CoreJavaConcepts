...
public class GenericInterfaceDemo {
	...
	public static void main(String[] args) {
		...
		MinMaxlmpl<Float> objOne = new MinMaxlmpl<Float>(arr);
		...
		MinMaxlmpl<String> objTwo = new MinMaxlmpl<String>(arrOne);
		...
		MinMaxlmpl<Person> objThree = new MinMaxlmpl<Person>(p);
